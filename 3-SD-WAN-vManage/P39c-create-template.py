...
# URL for creating Templates
URL_cTemplates = 'https://10.10.20.90/dataservice/template/device/feature'

PL = json.dumps({
    "templateName": "OE_template",
    "templateDescription": "OE testing",
...
Res_cTemplate = Sess_Login.post(url=URL_cTemplates, data=PL, headers=Headers, verify=False)
print (Res_cTemplate)