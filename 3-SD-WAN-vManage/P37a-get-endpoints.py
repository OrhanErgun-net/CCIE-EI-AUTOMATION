...
## Define URL for endpoints users
URL_EndPoints = 'https://10.10.20.90/dataservice/admin/user'

# URL_EndPoints = 'https://10.10.20.90/dataservice/admin/usergroup'

Res_EndPoints = Sess_Login.get(url=URL_EndPoints, verify=False).json()
print (json.dumps(Res_EndPoints["data"], indent=4))

# for item in Res_EndPoints['data']:
