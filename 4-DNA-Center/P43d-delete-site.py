...
# URL for delete site 
URL_Site_Delete = f"/dna/intent/api/v1/site/{Selected_ID}"
Res_Site_Delete = requests.delete(url=f"{DNAC}{URL_Site_Delete}", headers=Headers, verify=False).json()
print(json.dumps(Res_Site_Delete, indent=2))